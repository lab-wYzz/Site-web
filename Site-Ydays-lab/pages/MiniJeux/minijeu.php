...
<body>
    ...
    <div id="modal" class="modal">
        <h1>Mini Jeux</h1>
        <p>Les mini-jeux sont une manière amusante et interactive de gagner de l'expérience en culture générale. Les joueurs peuvent choisir parmi divers jeux et gagner de l'XP en les complétant. Cela encourage l'apprentissage et permet de débloquer de nouveaux mini-jeux et atteindre des niveaux supérieurs dans le jeu.</p>
